...
class NuscTrajdataAllTrainConfig(TrajdataTrainConfig):
    def __init__(self):
        super(NuscTrajdataAllTrainConfig, self).__init__()
...
class NuscTrajdataAllEnvConfig(TrajdataEnvConfig):
    def __init__(self):
        super(NuscTrajdataAllEnvConfig, self).__init__()
